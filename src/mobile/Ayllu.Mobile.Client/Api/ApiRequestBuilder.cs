...
using Ayllu.Mobile.Client.Api.V1;
...
using System;
namespace Ayllu.Mobile.Client.Api
{
    /// <summary>
    ...
    public partial class ApiRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Ayllu.Mobile.Client.Api.V1.V1RequestBuilder V1
        {
            get => new global::Ayllu.Mobile.Client.Api.V1.V1RequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Ayllu.Mobile.Client.Api.ApiRequestBuilder"/> and sets the default values.
        /// </summary>
