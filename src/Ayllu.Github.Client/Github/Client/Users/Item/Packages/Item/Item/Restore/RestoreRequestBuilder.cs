...
using System;
namespace Ayllu.Github.Client.Users.Item.Packages.Item.Item.Restore
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Ayllu.Github.Client.Users.Item.Packages.Item.Item.Restore.RestoreRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task PostAsync(Action<RequestConfiguration<global::Ayllu.Github.Client.Users.Item.Packages.Item.Item.Restore.RestoreRequestBuilder.RestoreRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task PostAsync(Action<RequestConfiguration<global::Ayllu.Github.Client.Users.Item.Packages.Item.Item.Restore.RestoreRequestBuilder.RestoreRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Action<RequestConfiguration<global::Ayllu.Github.Client.Users.Item.Packages.Item.Item.Restore.RestoreRequestBuilder.RestoreRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Action<RequestConfiguration<global::Ayllu.Github.Client.Users.Item.Packages.Item.Item.Restore.RestoreRequestBuilder.RestoreRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Ayllu.Github.Client.Users.Item.Packages.Item.Item.Restore.RestoreRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Ayllu.Github.Client.Users.Item.Packages.Item.Item.Restore.RestoreRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Ayllu.Github.Client.Users.Item.Packages.Item.Item.Restore.RestoreRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Restores an entire package for a user.You can restore a deleted package under the following conditions:  - The package was deleted within the last 30 days.  - The same package namespace and version is still available and not reused for a new package. If the same package namespace is not available, you will not be able to restore your package. In this scenario, to restore the deleted package, you must delete the new package that uses the deleted package&apos;s namespace first.If the `package_type` belongs to a GitHub Packages registry that supports granular permissions, the authenticated user must have admin permissions to the package. For the list of these registries, see &quot;[About permissions for GitHub Packages](https://docs.github.com/packages/learn-github-packages/about-permissions-for-github-packages#granular-permissions-for-userorganization-scoped-packages).&quot;OAuth app tokens and personal access tokens (classic) need the `read:packages` and `write:packages` scopes to use this endpoint. For more information, see &quot;[About permissions for GitHub Packages](https://docs.github.com/packages/learn-github-packages/about-permissions-for-github-packages#permissions-for-repository-scoped-packages).&quot;
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class RestoreRequestBuilderPostRequestConfiguration : RequestConfiguration<global::Ayllu.Github.Client.Users.Item.Packages.Item.Item.Restore.RestoreRequestBuilder.RestoreRequestBuilderPostQueryParameters>
        {
        }
    }
}
