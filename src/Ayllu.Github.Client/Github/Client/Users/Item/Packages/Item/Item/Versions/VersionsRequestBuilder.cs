...
using Ayllu.Github.Client.Users.Item.Packages.Item.Item.Versions.Item;
...
using System;
namespace Ayllu.Github.Client.Users.Item.Packages.Item.Item.Versions
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the Ayllu.Github.Client.users.item.packages.item.item.versions.item collection</summary>
        /// <param name="position">Unique identifier of the package version.</param>
        /// <returns>A <see cref="global::Ayllu.Github.Client.Users.Item.Packages.Item.Item.Versions.Item.WithPackage_version_ItemRequestBuilder"/></returns>
        public global::Ayllu.Github.Client.Users.Item.Packages.Item.Item.Versions.Item.WithPackage_version_ItemRequestBuilder this[int position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("package_version_id", position);
                return new global::Ayllu.Github.Client.Users.Item.Packages.Item.Item.Versions.Item.WithPackage_version_ItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>Gets an item from the Ayllu.Github.Client.users.item.packages.item.item.versions.item collection</summary>
        /// <param name="position">Unique identifier of the package version.</param>
        ...
        public global::Ayllu.Github.Client.Users.Item.Packages.Item.Item.Versions.Item.WithPackage_version_ItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Ayllu.Github.Client.Users.Item.Packages.Item.Item.Versions.VersionsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<List<global::Ayllu.Github.Client.Models.PackageVersion>?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::Ayllu.Github.Client.Models.PackageVersion>> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Ayllu.Github.Client.Users.Item.Packages.Item.Item.Versions.VersionsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Ayllu.Github.Client.Users.Item.Packages.Item.Item.Versions.VersionsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Ayllu.Github.Client.Users.Item.Packages.Item.Item.Versions.VersionsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
