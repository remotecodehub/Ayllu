...
using System;
namespace Ayllu.Github.Client.Users.Item.Settings.Billing.Usage
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Ayllu.Github.Client.Users.Item.Settings.Billing.Usage.UsageRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Ayllu.Github.Client.Models.BillingUsageReportUser"/></returns>
        ...
        /// <exception cref="global::Ayllu.Github.Client.Models.BillingUsageReportUser503Error">When receiving a 503 status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Ayllu.Github.Client.Models.BillingUsageReportUser?> GetAsync(Action<RequestConfiguration<global::Ayllu.Github.Client.Users.Item.Settings.Billing.Usage.UsageRequestBuilder.UsageRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Ayllu.Github.Client.Models.BillingUsageReportUser> GetAsync(Action<RequestConfiguration<global::Ayllu.Github.Client.Users.Item.Settings.Billing.Usage.UsageRequestBuilder.UsageRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>>
            {
                ...
                { "503", global::Ayllu.Github.Client.Models.BillingUsageReportUser503Error.CreateFromDiscriminatorValue },
            };
            return await RequestAdapter.SendAsync<global::Ayllu.Github.Client.Models.BillingUsageReportUser>(requestInfo, global::Ayllu.Github.Client.Models.BillingUsageReportUser.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Gets a report of the total usage for a user.**Note:** This endpoint is only available to users with access to the enhanced billing platform.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Ayllu.Github.Client.Users.Item.Settings.Billing.Usage.UsageRequestBuilder.UsageRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Ayllu.Github.Client.Users.Item.Settings.Billing.Usage.UsageRequestBuilder.UsageRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Ayllu.Github.Client.Users.Item.Settings.Billing.Usage.UsageRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Ayllu.Github.Client.Users.Item.Settings.Billing.Usage.UsageRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Ayllu.Github.Client.Users.Item.Settings.Billing.Usage.UsageRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets a report of the total usage for a user.**Note:** This endpoint is only available to users with access to the enhanced billing platform.
        /// </summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class UsageRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Ayllu.Github.Client.Users.Item.Settings.Billing.Usage.UsageRequestBuilder.UsageRequestBuilderGetQueryParameters>
        {
        }
    }
}
