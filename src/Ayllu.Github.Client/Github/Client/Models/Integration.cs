...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Ayllu.Github.Client.Models.Integration.Integration_owner? Owner { get; set; }
#nullable restore
#else
        public global::Ayllu.Github.Client.Models.Integration.Integration_owner Owner { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Ayllu.Github.Client.Models.Integration_permissions? Permissions { get; set; }
#nullable restore
#else
        public global::Ayllu.Github.Client.Models.Integration_permissions Permissions { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Ayllu.Github.Client.Models.Integration"/> and sets the default values.
        /// </summary>
        public Integration()
        {
        ...
        public static global::Ayllu.Github.Client.Models.Integration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Ayllu.Github.Client.Models.Integration();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "owner", n => { Owner = n.GetObjectValue<global::Ayllu.Github.Client.Models.Integration.Integration_owner>(global::Ayllu.Github.Client.Models.Integration.Integration_owner.CreateFromDiscriminatorValue); } },
                { "permissions", n => { Permissions = n.GetObjectValue<global::Ayllu.Github.Client.Models.Integration_permissions>(global::Ayllu.Github.Client.Models.Integration_permissions.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Ayllu.Github.Client.Models.Integration.Integration_owner>("owner", Owner);
            writer.WriteObjectValue<global::Ayllu.Github.Client.Models.Integration_permissions>("permissions", Permissions);
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::Ayllu.Github.Client.Models.Integration.Integration_owner"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::Ayllu.Github.Client.Models.Integration.Integration_owner CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
                var mappingValue = parseNode.GetChildNode("")?.GetStringValue();
                var result = new global::Ayllu.Github.Client.Models.Integration.Integration_owner();
