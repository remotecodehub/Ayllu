...
using Ayllu.Github.Client.Orgs.Item.Copilot.Billing.Seats;
using Ayllu.Github.Client.Orgs.Item.Copilot.Billing.Selected_teams;
using Ayllu.Github.Client.Orgs.Item.Copilot.Billing.Selected_users;
...
using System;
namespace Ayllu.Github.Client.Orgs.Item.Copilot.Billing
{
    /// <summary>
    ...
    public partial class BillingRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Ayllu.Github.Client.Orgs.Item.Copilot.Billing.Seats.SeatsRequestBuilder Seats
        {
            get => new global::Ayllu.Github.Client.Orgs.Item.Copilot.Billing.Seats.SeatsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The selected_teams property</summary>
        public global::Ayllu.Github.Client.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsRequestBuilder Selected_teams
        {
            get => new global::Ayllu.Github.Client.Orgs.Item.Copilot.Billing.Selected_teams.Selected_teamsRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        {
            get => new global::Ayllu.Github.Client.Orgs.Item.Copilot.Billing.Selected_users.Selected_usersRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Ayllu.Github.Client.Orgs.Item.Copilot.Billing.BillingRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Ayllu.Github.Client.Models.CopilotOrganizationDetails?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Ayllu.Github.Client.Models.CopilotOrganizationDetails> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Ayllu.Github.Client.Models.CopilotOrganizationDetails>(requestInfo, global::Ayllu.Github.Client.Models.CopilotOrganizationDetails.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// &gt; [!NOTE]&gt; This endpoint is in public preview and is subject to change.Gets information about an organization&apos;s Copilot subscription, including seat breakdownand feature policies. To configure these settings, go to your organization&apos;s settings on GitHub.com.For more information, see &quot;[Managing policies for Copilot in your organization](https://docs.github.com/copilot/managing-copilot/managing-policies-for-copilot-business-in-your-organization).&quot;Only organization owners can view details about the organization&apos;s Copilot Business or Copilot Enterprise subscription.OAuth app tokens and personal access tokens (classic) need either the `manage_billing:copilot` or `read:org` scopes to use this endpoint.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Ayllu.Github.Client.Orgs.Item.Copilot.Billing.BillingRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Ayllu.Github.Client.Orgs.Item.Copilot.Billing.BillingRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Ayllu.Github.Client.Orgs.Item.Copilot.Billing.BillingRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
