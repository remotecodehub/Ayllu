...
using System;
namespace Ayllu.Github.Client.Orgs.Item.CodeSecurity.Configurations.Defaults
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Ayllu.Github.Client.Orgs.Item.CodeSecurity.Configurations.Defaults.DefaultsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        public async Task<List<global::Ayllu.Github.Client.Models.CodeSecurityDefaultConfigurations>> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::Ayllu.Github.Client.Models.CodeSecurityDefaultConfigurations>(requestInfo, global::Ayllu.Github.Client.Models.CodeSecurityDefaultConfigurations.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Ayllu.Github.Client.Orgs.Item.CodeSecurity.Configurations.Defaults.DefaultsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Ayllu.Github.Client.Orgs.Item.CodeSecurity.Configurations.Defaults.DefaultsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Ayllu.Github.Client.Orgs.Item.CodeSecurity.Configurations.Defaults.DefaultsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
