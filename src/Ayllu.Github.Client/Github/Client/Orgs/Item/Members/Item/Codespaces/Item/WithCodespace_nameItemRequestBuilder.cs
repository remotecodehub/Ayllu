...
using Ayllu.Github.Client.Orgs.Item.Members.Item.Codespaces.Item.Stop;
...
using System;
namespace Ayllu.Github.Client.Orgs.Item.Members.Item.Codespaces.Item
{
    /// <summary>
    ...
    public partial class WithCodespace_nameItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Ayllu.Github.Client.Orgs.Item.Members.Item.Codespaces.Item.Stop.StopRequestBuilder Stop
        {
            get => new global::Ayllu.Github.Client.Orgs.Item.Members.Item.Codespaces.Item.Stop.StopRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Ayllu.Github.Client.Orgs.Item.Members.Item.Codespaces.Item.WithCodespace_nameItemRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Ayllu.Github.Client.Orgs.Item.Members.Item.Codespaces.Item.WithCodespace_nameDeleteResponse"/></returns>
...
#nullable enable
        public async Task<global::Ayllu.Github.Client.Orgs.Item.Members.Item.Codespaces.Item.WithCodespace_nameDeleteResponse?> DeleteAsWithCodespace_nameDeleteResponseAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Ayllu.Github.Client.Orgs.Item.Members.Item.Codespaces.Item.WithCodespace_nameDeleteResponse> DeleteAsWithCodespace_nameDeleteResponseAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        ...
        /// API method documentation <see href="https://docs.github.com/rest/codespaces/organizations#delete-a-codespace-from-the-organization" />
        /// </summary>
        /// <returns>A <see cref="global::Ayllu.Github.Client.Orgs.Item.Members.Item.Codespaces.Item.WithCodespace_nameResponse"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::Ayllu.Github.Client.Models.BasicError">When receiving a 401 status code</exception>
        /// <exception cref="global::Ayllu.Github.Client.Models.BasicError">When receiving a 403 status code</exception>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Ayllu.Github.Client.Orgs.Item.Members.Item.Codespaces.Item.WithCodespace_nameResponse?> DeleteAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Ayllu.Github.Client.Orgs.Item.Members.Item.Codespaces.Item.WithCodespace_nameResponse> DeleteAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Ayllu.Github.Client.Orgs.Item.Members.Item.Codespaces.Item.WithCodespace_nameItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Ayllu.Github.Client.Orgs.Item.Members.Item.Codespaces.Item.WithCodespace_nameItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
