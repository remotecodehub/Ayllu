...
#nullable restore
        ...
        public global::Ayllu.Github.Client.Orgs.Item.PrivateRegistries.PrivateRegistriesPostRequestBody_registry_type? RegistryType { get; set; }
...
#nullable restore
        ...
        public global::Ayllu.Github.Client.Orgs.Item.PrivateRegistries.PrivateRegistriesPostRequestBody_visibility? Visibility { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Ayllu.Github.Client.Orgs.Item.PrivateRegistries.PrivateRegistriesPostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Ayllu.Github.Client.Orgs.Item.PrivateRegistries.PrivateRegistriesPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Ayllu.Github.Client.Orgs.Item.PrivateRegistries.PrivateRegistriesPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Ayllu.Github.Client.Orgs.Item.PrivateRegistries.PrivateRegistriesPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "registry_type", n => { RegistryType = n.GetEnumValue<global::Ayllu.Github.Client.Orgs.Item.PrivateRegistries.PrivateRegistriesPostRequestBody_registry_type>(); } },
                { "selected_repository_ids", n => { SelectedRepositoryIds = n.GetCollectionOfPrimitiveValues<int?>()?.AsList(); } },
                { "url", n => { Url = n.GetStringValue(); } },
                { "username", n => { Username = n.GetStringValue(); } },
                { "visibility", n => { Visibility = n.GetEnumValue<global::Ayllu.Github.Client.Orgs.Item.PrivateRegistries.PrivateRegistriesPostRequestBody_visibility>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Ayllu.Github.Client.Orgs.Item.PrivateRegistries.PrivateRegistriesPostRequestBody_registry_type>("registry_type", RegistryType);
            writer.WriteCollectionOfPrimitiveValues<int?>("selected_repository_ids", SelectedRepositoryIds);
            writer.WriteStringValue("url", Url);
            writer.WriteStringValue("username", Username);
            writer.WriteEnumValue<global::Ayllu.Github.Client.Orgs.Item.PrivateRegistries.PrivateRegistriesPostRequestBody_visibility>("visibility", Visibility);
