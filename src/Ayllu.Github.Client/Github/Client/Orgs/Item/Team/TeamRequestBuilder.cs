...
using Ayllu.Github.Client.Orgs.Item.Team.Item;
...
using System;
namespace Ayllu.Github.Client.Orgs.Item.Team
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the Ayllu.Github.Client.orgs.item.team.item collection</summary>
        /// <param name="position">The slug of the team name.</param>
        /// <returns>A <see cref="global::Ayllu.Github.Client.Orgs.Item.Team.Item.WithTeam_slugItemRequestBuilder"/></returns>
        public global::Ayllu.Github.Client.Orgs.Item.Team.Item.WithTeam_slugItemRequestBuilder this[string position]
        {
            get
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Ayllu.Github.Client.Orgs.Item.Team.TeamRequestBuilder"/> and sets the default values.
        /// </summary>
