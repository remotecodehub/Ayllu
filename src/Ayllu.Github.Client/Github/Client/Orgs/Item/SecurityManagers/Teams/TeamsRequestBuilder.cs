...
using Ayllu.Github.Client.Orgs.Item.SecurityManagers.Teams.Item;
...
using System;
namespace Ayllu.Github.Client.Orgs.Item.SecurityManagers.Teams
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the Ayllu.Github.Client.orgs.item.securityManagers.teams.item collection</summary>
        /// <param name="position">The slug of the team name.</param>
        /// <returns>A <see cref="global::Ayllu.Github.Client.Orgs.Item.SecurityManagers.Teams.Item.WithTeam_slugItemRequestBuilder"/></returns>
        [Obsolete("")]
        public global::Ayllu.Github.Client.Orgs.Item.SecurityManagers.Teams.Item.WithTeam_slugItemRequestBuilder this[string position]
        {
            get
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Ayllu.Github.Client.Orgs.Item.SecurityManagers.Teams.TeamsRequestBuilder"/> and sets the default values.
        /// </summary>
