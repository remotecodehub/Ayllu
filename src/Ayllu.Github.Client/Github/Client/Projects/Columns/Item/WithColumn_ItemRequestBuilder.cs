...
using Ayllu.Github.Client.Projects.Columns.Item.Cards;
using Ayllu.Github.Client.Projects.Columns.Item.Moves;
...
using System;
namespace Ayllu.Github.Client.Projects.Columns.Item
{
    /// <summary>
    ...
    public partial class WithColumn_ItemRequestBuilder : BaseRequestBuilder
    {
        ...
        [Obsolete("")]
        public global::Ayllu.Github.Client.Projects.Columns.Item.Cards.CardsRequestBuilder Cards
        {
            get => new global::Ayllu.Github.Client.Projects.Columns.Item.Cards.CardsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The moves property</summary>
        [Obsolete("")]
        public global::Ayllu.Github.Client.Projects.Columns.Item.Moves.MovesRequestBuilder Moves
        {
            get => new global::Ayllu.Github.Client.Projects.Columns.Item.Moves.MovesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Ayllu.Github.Client.Projects.Columns.Item.WithColumn_ItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Ayllu.Github.Client.Models.ProjectColumn?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Ayllu.Github.Client.Models.ProjectColumn> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Ayllu.Github.Client.Models.ProjectColumn?> PatchAsync(global::Ayllu.Github.Client.Projects.Columns.Item.WithColumn_PatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Ayllu.Github.Client.Models.ProjectColumn> PatchAsync(global::Ayllu.Github.Client.Projects.Columns.Item.WithColumn_PatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::Ayllu.Github.Client.Projects.Columns.Item.WithColumn_PatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::Ayllu.Github.Client.Projects.Columns.Item.WithColumn_PatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        [Obsolete("")]
        public global::Ayllu.Github.Client.Projects.Columns.Item.WithColumn_ItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Ayllu.Github.Client.Projects.Columns.Item.WithColumn_ItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
