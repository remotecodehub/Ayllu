...
using System;
namespace Ayllu.Github.Client.Repos.Item.Item.Codespaces.Permissions_check
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Ayllu.Github.Client.Repos.Item.Item.Codespaces.Permissions_check.Permissions_checkRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Ayllu.Github.Client.Models.CodespacesPermissionsCheckForDevcontainer"/></returns>
        ...
        /// <exception cref="global::Ayllu.Github.Client.Models.CodespacesPermissionsCheckForDevcontainer503Error">When receiving a 503 status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Ayllu.Github.Client.Models.CodespacesPermissionsCheckForDevcontainer?> GetAsync(Action<RequestConfiguration<global::Ayllu.Github.Client.Repos.Item.Item.Codespaces.Permissions_check.Permissions_checkRequestBuilder.Permissions_checkRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Ayllu.Github.Client.Models.CodespacesPermissionsCheckForDevcontainer> GetAsync(Action<RequestConfiguration<global::Ayllu.Github.Client.Repos.Item.Item.Codespaces.Permissions_check.Permissions_checkRequestBuilder.Permissions_checkRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>>
            {
                ...
                { "503", global::Ayllu.Github.Client.Models.CodespacesPermissionsCheckForDevcontainer503Error.CreateFromDiscriminatorValue },
            };
            return await RequestAdapter.SendAsync<global::Ayllu.Github.Client.Models.CodespacesPermissionsCheckForDevcontainer>(requestInfo, global::Ayllu.Github.Client.Models.CodespacesPermissionsCheckForDevcontainer.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Checks whether the permissions defined by a given devcontainer configuration have been accepted by the authenticated user.OAuth app tokens and personal access tokens (classic) need the `codespace` scope to use this endpoint.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Ayllu.Github.Client.Repos.Item.Item.Codespaces.Permissions_check.Permissions_checkRequestBuilder.Permissions_checkRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Ayllu.Github.Client.Repos.Item.Item.Codespaces.Permissions_check.Permissions_checkRequestBuilder.Permissions_checkRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Ayllu.Github.Client.Repos.Item.Item.Codespaces.Permissions_check.Permissions_checkRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Ayllu.Github.Client.Repos.Item.Item.Codespaces.Permissions_check.Permissions_checkRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Ayllu.Github.Client.Repos.Item.Item.Codespaces.Permissions_check.Permissions_checkRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Checks whether the permissions defined by a given devcontainer configuration have been accepted by the authenticated user.OAuth app tokens and personal access tokens (classic) need the `codespace` scope to use this endpoint.
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Permissions_checkRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Ayllu.Github.Client.Repos.Item.Item.Codespaces.Permissions_check.Permissions_checkRequestBuilder.Permissions_checkRequestBuilderGetQueryParameters>
        {
        }
    }
}
