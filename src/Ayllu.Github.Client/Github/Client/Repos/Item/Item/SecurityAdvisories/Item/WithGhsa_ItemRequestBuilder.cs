...
using Ayllu.Github.Client.Repos.Item.Item.SecurityAdvisories.Item.Cve;
using Ayllu.Github.Client.Repos.Item.Item.SecurityAdvisories.Item.Forks;
...
using System;
namespace Ayllu.Github.Client.Repos.Item.Item.SecurityAdvisories.Item
{
    /// <summary>
    ...
    public partial class WithGhsa_ItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Ayllu.Github.Client.Repos.Item.Item.SecurityAdvisories.Item.Cve.CveRequestBuilder Cve
        {
            get => new global::Ayllu.Github.Client.Repos.Item.Item.SecurityAdvisories.Item.Cve.CveRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The forks property</summary>
        public global::Ayllu.Github.Client.Repos.Item.Item.SecurityAdvisories.Item.Forks.ForksRequestBuilder Forks
        {
            get => new global::Ayllu.Github.Client.Repos.Item.Item.SecurityAdvisories.Item.Forks.ForksRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Ayllu.Github.Client.Repos.Item.Item.SecurityAdvisories.Item.WithGhsa_ItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Ayllu.Github.Client.Models.RepositoryAdvisory?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Ayllu.Github.Client.Models.RepositoryAdvisory> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Ayllu.Github.Client.Models.RepositoryAdvisory?> PatchAsync(global::Ayllu.Github.Client.Models.RepositoryAdvisoryUpdate body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Ayllu.Github.Client.Models.RepositoryAdvisory> PatchAsync(global::Ayllu.Github.Client.Models.RepositoryAdvisoryUpdate body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::Ayllu.Github.Client.Models.RepositoryAdvisoryUpdate body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::Ayllu.Github.Client.Models.RepositoryAdvisoryUpdate body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Ayllu.Github.Client.Repos.Item.Item.SecurityAdvisories.Item.WithGhsa_ItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Ayllu.Github.Client.Repos.Item.Item.SecurityAdvisories.Item.WithGhsa_ItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
