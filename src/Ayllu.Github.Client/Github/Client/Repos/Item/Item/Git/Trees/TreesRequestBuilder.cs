...
using Ayllu.Github.Client.Repos.Item.Item.Git.Trees.Item;
...
using System;
namespace Ayllu.Github.Client.Repos.Item.Item.Git.Trees
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the Ayllu.Github.Client.repos.item.item.git.trees.item collection</summary>
        ...
        public global::Ayllu.Github.Client.Repos.Item.Item.Git.Trees.Item.WithTree_shaItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("tree_sha", position);
                return new global::Ayllu.Github.Client.Repos.Item.Item.Git.Trees.Item.WithTree_shaItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Ayllu.Github.Client.Repos.Item.Item.Git.Trees.TreesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Ayllu.Github.Client.Models.GitTree?> PostAsync(global::Ayllu.Github.Client.Repos.Item.Item.Git.Trees.TreesPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Ayllu.Github.Client.Models.GitTree> PostAsync(global::Ayllu.Github.Client.Repos.Item.Item.Git.Trees.TreesPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Ayllu.Github.Client.Repos.Item.Item.Git.Trees.TreesPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Ayllu.Github.Client.Repos.Item.Item.Git.Trees.TreesPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Ayllu.Github.Client.Repos.Item.Item.Git.Trees.TreesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Ayllu.Github.Client.Repos.Item.Item.Git.Trees.TreesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Ayllu.Github.Client.Repos.Item.Item.Git.Trees.TreesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
