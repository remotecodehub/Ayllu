...
using Ayllu.Github.Client.Repos.Item.Item.DependencyGraph.Compare.Item;
...
using System;
namespace Ayllu.Github.Client.Repos.Item.Item.DependencyGraph.Compare
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the Ayllu.Github.Client.repos.item.item.dependencyGraph.compare.item collection</summary>
        ...
        public global::Ayllu.Github.Client.Repos.Item.Item.DependencyGraph.Compare.Item.WithBaseheadItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("basehead", position);
                return new global::Ayllu.Github.Client.Repos.Item.Item.DependencyGraph.Compare.Item.WithBaseheadItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Ayllu.Github.Client.Repos.Item.Item.DependencyGraph.Compare.CompareRequestBuilder"/> and sets the default values.
        /// </summary>
