...
using Ayllu.Github.Client.Repos.Item.Item.CheckSuites.Item.CheckRuns;
using Ayllu.Github.Client.Repos.Item.Item.CheckSuites.Item.Rerequest;
...
using System;
namespace Ayllu.Github.Client.Repos.Item.Item.CheckSuites.Item
{
    /// <summary>
    ...
    public partial class WithCheck_suite_ItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Ayllu.Github.Client.Repos.Item.Item.CheckSuites.Item.CheckRuns.CheckRunsRequestBuilder CheckRuns
        {
            get => new global::Ayllu.Github.Client.Repos.Item.Item.CheckSuites.Item.CheckRuns.CheckRunsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The rerequest property</summary>
        public global::Ayllu.Github.Client.Repos.Item.Item.CheckSuites.Item.Rerequest.RerequestRequestBuilder Rerequest
        {
            get => new global::Ayllu.Github.Client.Repos.Item.Item.CheckSuites.Item.Rerequest.RerequestRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Ayllu.Github.Client.Repos.Item.Item.CheckSuites.Item.WithCheck_suite_ItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Ayllu.Github.Client.Models.CheckSuite?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Ayllu.Github.Client.Models.CheckSuite> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Ayllu.Github.Client.Repos.Item.Item.CheckSuites.Item.WithCheck_suite_ItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Ayllu.Github.Client.Repos.Item.Item.CheckSuites.Item.WithCheck_suite_ItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
