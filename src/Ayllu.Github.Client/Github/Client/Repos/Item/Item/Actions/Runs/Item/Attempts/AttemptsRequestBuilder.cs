...
using Ayllu.Github.Client.Repos.Item.Item.Actions.Runs.Item.Attempts.Item;
...
using System;
namespace Ayllu.Github.Client.Repos.Item.Item.Actions.Runs.Item.Attempts
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the Ayllu.Github.Client.repos.item.item.actions.runs.item.attempts.item collection</summary>
        ...
        public global::Ayllu.Github.Client.Repos.Item.Item.Actions.Runs.Item.Attempts.Item.WithAttempt_numberItemRequestBuilder this[int position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("attempt_number", position);
                return new global::Ayllu.Github.Client.Repos.Item.Item.Actions.Runs.Item.Attempts.Item.WithAttempt_numberItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>Gets an item from the Ayllu.Github.Client.repos.item.item.actions.runs.item.attempts.item collection</summary>
        /// <param name="position">The attempt number of the workflow run.</param>
        ...
        public global::Ayllu.Github.Client.Repos.Item.Item.Actions.Runs.Item.Attempts.Item.WithAttempt_numberItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Ayllu.Github.Client.Repos.Item.Item.Actions.Runs.Item.Attempts.AttemptsRequestBuilder"/> and sets the default values.
        /// </summary>
