...
namespace Ayllu.Github.Client.AppManifests
{
    ...
    {
        /// <summary>Gets an item from the Ayllu.Github.Client.appManifests.item collection</summary>
        /// <param name="position">Unique identifier of the item</param>
        /// <returns>A <see cref="global::Ayllu.Github.Client.AppManifests.Item.WithCodeItemRequestBuilder"/></returns>
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Ayllu.Github.Client.AppManifests.AppManifestsRequestBuilder"/> and sets the default values.
        /// </summary>
