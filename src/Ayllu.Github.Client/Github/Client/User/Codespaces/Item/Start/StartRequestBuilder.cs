...
using System;
namespace Ayllu.Github.Client.User.Codespaces.Item.Start
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Ayllu.Github.Client.User.Codespaces.Item.Start.StartRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <exception cref="global::Ayllu.Github.Client.Models.BasicError">When receiving a 402 status code</exception>
...
#nullable enable
        public async Task<global::Ayllu.Github.Client.Models.Codespace?> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Ayllu.Github.Client.Models.Codespace> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>>
            {
                ...
                { "402", global::Ayllu.Github.Client.Models.BasicError.CreateFromDiscriminatorValue },
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Ayllu.Github.Client.User.Codespaces.Item.Start.StartRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Ayllu.Github.Client.User.Codespaces.Item.Start.StartRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Ayllu.Github.Client.User.Codespaces.Item.Start.StartRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
