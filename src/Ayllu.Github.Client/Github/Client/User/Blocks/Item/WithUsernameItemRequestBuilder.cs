...
using System;
namespace Ayllu.Github.Client.User.Blocks.Item
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Ayllu.Github.Client.User.Blocks.Item.WithUsernameItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Ayllu.Github.Client.User.Blocks.Item.WithUsernameItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Ayllu.Github.Client.User.Blocks.Item.WithUsernameItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
