...
using System;
namespace Ayllu.Github.Client.Applications.Item.Token.Scoped
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Ayllu.Github.Client.Applications.Item.Token.Scoped.ScopedRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Ayllu.Github.Client.Models.Authorization?> PostAsync(global::Ayllu.Github.Client.Applications.Item.Token.Scoped.ScopedPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Ayllu.Github.Client.Models.Authorization> PostAsync(global::Ayllu.Github.Client.Applications.Item.Token.Scoped.ScopedPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Ayllu.Github.Client.Applications.Item.Token.Scoped.ScopedPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Ayllu.Github.Client.Applications.Item.Token.Scoped.ScopedPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Ayllu.Github.Client.Applications.Item.Token.Scoped.ScopedRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Ayllu.Github.Client.Applications.Item.Token.Scoped.ScopedRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Ayllu.Github.Client.Applications.Item.Token.Scoped.ScopedRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
