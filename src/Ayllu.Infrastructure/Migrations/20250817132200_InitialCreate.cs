        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Dialectics_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Dialectics_Users_CreatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_UserConnections_Order", "[User1Id] < [User2Id]");
                    table.ForeignKey(
                        name: "FK_UserConnections_Users_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserConnections_Users_AppUserId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DialecticStages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DialecticStages_Dialectics_DialecticId",
                        column: x => x.DialecticId,
                        principalTable: "Dialectics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DialecticStages_Users_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dialectics_CreatedById",
                table: "Dialectics",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_Dialectics_OrganizationId",
                table: "Dialectics",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_DialecticStages_AuthorId",
                table: "DialecticStages",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_DialecticStages_DialecticId",
                table: "DialecticStages",
                column: "DialecticId");

            migrationBuilder.CreateIndex(
                name: "IX_InvalidatedTokens_Jwt",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserConnections_AppUserId1",
                table: "UserConnections",
                column: "AppUserId1");
